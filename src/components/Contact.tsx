        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-12 mb-16 md:mb-20">
            <div className="max-w-2xl px-2 md:px-0">
              ...
              <h2 className="text-5xl sm:text-6xl md:text-8xl font-display font-black tracking-tightest leading-[0.9] uppercase">
                Establish <br />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              className="lg:col-span-7 bg-white/[0.02] border border-white/5 rounded-[40px] p-8 sm:p-12 md:p-16 relative overflow-hidden group"
            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-12">
                  <div className="space-y-4">
                    ...
                    <input 
                      ...
                      className="w-full bg-transparent border-b border-white/10 py-3 md:py-4 outline-none focus:border-white transition-colors text-xl sm:text-2xl font-display font-black tracking-tight placeholder:text-white/5"
                    />
                  </div>
                  <div className="space-y-4">
            ...
            <div className="lg:col-span-5 grid grid-cols-1 gap-6">
              ...
              <motion.div 
                ...
                className="bg-white/[0.02] border border-white/5 rounded-[40px] p-8 sm:p-10 flex flex-col justify-between group hover:bg-white/[0.04] transition-colors"
              >
                <div className="flex justify-between items-start mb-10 md:mb-12">
                  <div className="text-[10px] font-mono text-white/40 uppercase tracking-[0.4em] font-bold">Physical_Base</div>
                  <Globe className="text-white/20 group-hover:rotate-12 transition-transform duration-700" size={20} />
                </div>
                <div>
                  <h3 className="text-2xl sm:text-3xl font-display font-black text-white mb-4 sm:mb-6 uppercase tracking-tight">Dubai_SC</h3>
                  <p className="text-xs sm:text-sm text-white/30 font-light leading-relaxed tracking-wider uppercase">
              ...
              <motion.div 
                ...
                className="bg-white/[0.02] border border-white/5 rounded-[40px] p-8 sm:p-10 group hover:border-white/20 transition-all"
              >
                <div className="text-[10px] font-mono text-white/40 uppercase tracking-[0.4em] font-bold mb-8 md:mb-10">Direct_Frequency</div>
                <div className="space-y-6 md:space-y-8">
                  <div>
                    ...
                    <a href="mailto:production@sngocreations.com" className="text-base sm:text-lg font-display font-black text-white/60 hover:text-white transition-colors italic break-all sm:break-normal">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8">
                    <div>
                      ...
                      <span className="text-sm sm:text-base font-display font-black text-white/40 hover:text-white transition-colors cursor-pointer tracking-tighter">
                        +971 503507879
                      </span>
                    </div>
                    <div>
